    ...
    <main className="min-h-screen bg-[#f2eef1] text-ink">
      <div className="flex min-h-screen w-full">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <WorkHomeHeader center={profile?.centerName ?? 'Cargando…'} campaign="Campaña 2026" search={search} onSearchChange={onSearchChange} searchPlaceholder={activeSubsection === 'Laboratorio' ? 'Buscar muestra o depósito' : 'Buscar depósito, lote o contenido'} onOpenNotices={() => onNavigate('account')} onOpenProfile={() => onNavigate('account')} profile={profile} />
